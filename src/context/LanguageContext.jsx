...
const translations = {
  en: {
    ...
    // Blog Page
    blog: "Blog",
    blogDescription: "Latest news and insights from Hive Records",
    ...
    studioDescription:
      "Hive Records is a Kyrenia-based recording studio, open 24/7 for artists who never sleep on creativity. Whether you're laying down your first demo or producing a full album, our space is built for all levels of talent. From vocal booths to mixing and mastering — we offer everything you need to bring your sound to life.",
  ...
  tr: {
    ...
    // Blog Page
    blog: "Blog",
    blogDescription: "Hive Records'tan en son haberler ve içgörüler",
    recentPosts: "Son Yazılar",
    blogContactText:
      "Hizmetlerimiz hakkında sorularınız mı var veya bir rezervasyon mu yapmak istiyorsunuz?",
    ...
    getInTouchDesc:
      "Ekibimizle iletişime geçin ve birlikte harika bir şeyler yaratalım",
